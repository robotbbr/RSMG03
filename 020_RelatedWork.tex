...
Answer set programming (ASP) is an approach to declarative problem solving, combining a rich and simple modelling language with high performance solving capacities. It has its roots in deductive databases, logic programming (with negation), logic-based knwoledge representation and (nonmonotomic) reasoning, and constraint solving (satisfiability testing) \citep{Gebser2013_ASP}.
